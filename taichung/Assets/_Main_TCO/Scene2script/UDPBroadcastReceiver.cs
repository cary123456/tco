        ...
        if (listener.Available > 0 )
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    mmWaveInfo = $"û‘ª“ {objectList.Length} ŒÂ•¨é“";
                    mmWaveConnected = true;
            ...
            catch (SocketException e)
            {
                ...
                mmWaveInfo = "Ÿ|•Ä”g˜AüˆÙíC¿Šm’è˜AüPort¥”Ûˆ×" + udpPort.ToString() + "Œn“öŒë‘u”@‰º\n" + e;
            }
            catch (Exception e)
            {
                Debug.Log(e.Message);
                mmWaveConnected = false;
                mmWaveInfo = "Ÿ|•Ä”gˆÙíC–¢”\³Šm™¯öŒëC¿è“®”rœöŒëCŒn“öŒë‘u”@‰ºF\n" + e;
            }
        }
        else
        {
            mmWaveConnected = false;
            mmWaveInfo = "Ÿ|•Ä”gŸ“—L˜AÚC¿Šm’è¥”ÛÚãUSB•ÀŠİ’è˜AüPortˆ×" + udpPort.ToString();
        }
