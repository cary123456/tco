...
public class OperationInfo_SO : ScriptableObject
{
    ...
    [ReadOnly][TextArea(1,2)] public string mmWaveInfo = "";
    ...
    [SerializeField] public List<MidiDevice> connectedMIDIDevices = new List<MidiDevice>();
    ...
    [ReadOnly][TextArea(1,2)] public string ObjectsControlInfo = "";
    [Tooltip("是否允許建築物生成")]
    [ReadOnly][SerializeField] public bool EnablingBuildingInstantiate;
    [Tooltip("是否允許螃蟹生成")]
    [ReadOnly][SerializeField] public bool EnablingCrabInstantiate;
    [Tooltip("是否允許漁人生成")]
    [ReadOnly][SerializeField] public bool EnablingFishmanInstantiate;
}
