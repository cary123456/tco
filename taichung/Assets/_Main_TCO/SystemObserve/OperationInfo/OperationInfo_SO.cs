...
public class OperationInfo_SO : ScriptableObject
{
    ...
    [SerializeField] public bool inOperation = false;
    ...
    [SerializeField] public bool mmWaveScriptActive = false;
    [SerializeField] public bool mmWaveMouseControl = false;
    [SerializeField] public string mmWaveSettedPorts = "";
    [TextArea(1,3)] public string mmWaveInfo = "";
    ...
    [TextArea(1,2)] public string ObjectsControlInfo = "";
    [Tooltip("是否允許建築物生成")]
