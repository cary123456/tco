...
// System.Void Meta.Voice.Samples.Dictation.SimpleLabelResizer::RefreshSize()
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Meta.Voice.Samples.Dictation.DictationActivation::ToggleActivation()
...
{
	{
		...
		DictationService_t120A3B548978DE9D6F3EF299907186C4AC963F3A* L_0 = __this->____dictation_4;
		NullCheck(L_0);
		bool L_1;
		L_1 = VirtualFuncInvoker0< bool >::Invoke(24 /* System.Boolean Meta.WitAi.Dictation.DictationService::get_MicActive() */, L_0);
		if (!L_1)
		{
			goto IL_0019;
		}
	}
	{
		...
		DictationService_t120A3B548978DE9D6F3EF299907186C4AC963F3A* L_2 = __this->____dictation_4;
		NullCheck(L_2);
		VirtualActionInvoker0::Invoke(30 /* System.Void Meta.WitAi.Dictation.DictationService::Deactivate() */, L_2);
		return;
	}
...
IL_0019:
	{
		// _dictation.Activate();
		DictationService_t120A3B548978DE9D6F3EF299907186C4AC963F3A* L_3 = __this->____dictation_4;
		NullCheck(L_3);
...
// System.Void Meta.Voice.Samples.Dictation.DictationActivation::.ctor()
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Meta.Voice.Samples.Dictation.SimpleLabelResizer::Reset()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SimpleLabelResizer_Reset_mBD750D2E1507CEDA1B296158103883576EA19AEF (SimpleLabelResizer_t07C2D3BF2DDDF56F9E5967B1CE126BC3B2CA2070* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->____label_4 = L_1;
		Il2CppCodeGenWriteBarrier((void**)(&__this->____label_4), (void*)L_1);
		// }
		return;
	}
}
// System.Void Meta.Voice.Samples.Dictation.SimpleLabelResizer::Awake()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SimpleLabelResizer_Awake_mA37E6A6653CEB7A2A9948A31ABE87E02A9065F7A (SimpleLabelResizer_t07C2D3BF2DDDF56F9E5967B1CE126BC3B2CA2070* __this, const RuntimeMethod* method) 
{
	...
	{
		// if (_label == null)
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_0 = __this->____label_4;
...
// System.Void Meta.Voice.Samples.Dictation.SimpleLabelResizer::Update()
...
{
	{
		...
		String_t* L_0 = __this->____text_5;
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_1 = __this->____label_4;
		NullCheck(L_1);
		String_t* L_2;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SimpleLabelResizer_RefreshSize_m20D92ACB09FD14EB12BBF33A42983CB956F2E4FB (SimpleLabelResizer_t07C2D3BF2DDDF56F9E5967B1CE126BC3B2CA2070* __this, const RuntimeMethod* method) 
{
	float V_0 = 0.0f;
	{
		...
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_2 = __this->____label_4;
		NullCheck(L_2);
		float L_3;
		L_3 = VirtualFuncInvoker0< float >::Invoke(85 /* System.Single TMPro.TMP_Text::get_preferredHeight() */, L_2);
		V_0 = L_3;
		// _label.rectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, preferredHeight);
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_4 = __this->____label_4;
		NullCheck(L_4);
...
// System.Void Meta.Voice.Samples.Dictation.SimpleLabelResizer::.ctor()
